 ...
 * and is labelled as such in the list, so the staff member can see which expenses
 ...
 * normalising on the way in keeps the number the staff member typed on the receipt
