 ...
 * an operator can tell what they entered from what the system entered for them.
  ...
  const rowMenu = [
    {
      ...
      // the write regardless; this only saves the operator the round trip.
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        body={
          deleting
            ? `${deleting.description} — ${money(deleting.amount)}. This removes it from the P&L and cannot be undone.`
            : ''
        }
